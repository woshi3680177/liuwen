...
P3, the server interacts with the card organization and obtains the token of the bank card, saves and returns it to the mobile terminal

P4, the mobile terminal will save the token
