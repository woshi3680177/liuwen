...
\section{Introduction}
\IEEEPARstart
{P}ayment methods range from initial cash payment to credit card payment, to current scan code, NFC payment. Although mobile payments are increasingly convenient, the security issues faced are more and more complex than ever. Mobile payment security has received more and more attention along with the popularity of mobile payment.
%{I}
